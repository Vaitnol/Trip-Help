...
const Map = ({coordinates, setBounds, setCoordinates, places}) => {
  ...
  return (
    <div className={classes.mapContainer}>
      <GoogleMapReact
        bootstrapURLKeys={{key: 'AIzaSyA_eL6oZYZC1z5iNq1jtgAi-7MR_7EdD9g'}}
      ...
      >
        {places?.map((place, i) => (
          <div className={classes.mapContainer} lat={Number(place.latitude)} lng={Number(place.longitude)} key={i}>
            {
